			...
			<div className="grid grid-cols-1 sm:grid-cols-12">
				<div className="col-span-7 sm:col-span-7 place-self-center">
					...
					<p className="text-[#c3cacf] text-lg sm:text-left lg:text-xl mb-6 mr-6">
						...
						for me to work them into reality.
						<br />
						Firm believer in the idea that if we act from a place of
						expansion and inspiration and not from a place of fear
						and scaredness <i>magical things </i>can happen and will
						happen.
					</p>
					<div>
						...
						<button className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-full px-1 py-3 bg-transparent mr-6 ">
							<span className="text-white rounded-full px-3 py-3 bg-[#121212] hover:bg-transparent  ">
								Download CV
							</span>
						</button>
					</div>
